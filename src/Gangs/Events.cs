...
public partial class Plugin
{
                        ...
                        if (await reader.ReadAsync() == false)
                        {
                            ...
                            else if (userInfo[slot].Status == 2)
                            {
                                ...
                                Server.NextFrame(() =>
                                {
                                    ...
                                    AddScoreboardTagToPlayer(player, true);
                                });
                            }
                        }
                        else
    ...
    HookResult EventPlayerConnectFull(EventPlayerConnectFull @event, GameEventInfo @eventInfo)
    {
    ...
    HookResult EventPlayerDisconnect(EventPlayerDisconnect @event, GameEventInfo info)
    {
        ...
        if (userInfo.ContainsKey(player.Slot))
            userInfo.Remove(player.Slot);
